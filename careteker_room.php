...
$userid = $_SESSION['user_id'];
            ...
            // fetch data from hostel_accomodation table name
...
<nav class="navbar navbar-light navbar-fixed-top" style="background-color: #e3f2fd;">
    ...
    <div class="div2">
		...
		<div class="col-sm-12" >
			...
			<!-- hare table is for allotment of room by registration no. or Details-->
							<table>
                <tr><th><div id="" style="margin-top:50px" class="mainbox col-md-9 col-md-offset-1 col-sm-8 col-sm-offset-3">
                <div class="panel panel-info">
                 <div class="panel-heading">
                  <div class="panel-title">Allot By Registration Number</div>
                   <div style="float:right; font-size: 85%; position: relative; top:-10px"><a id="signinlink" href="appoint.php"></a></div>
                   </div>  
                    <div class="panel-body" >
                     <form style="background-image:url(back/10.jpg);" id="book" class="form-horizontal" role="form" action="allot_room_backend.php" method="post">
...
<br><br>
                ...
                <th><div id="signupbox" style="margin-top:50px" class="mainbox col-md-12 col-md-offset-1 col-sm-8 col-sm-offset-3">
                 <div class="panel panel-info">
                  <div class="panel-heading">
                   <div class="panel-title">Allot By Details</div>
                    <div style="float:right; font-size: 85%; position: relative; top:-10px"><a id="signinlink" href="appoint.php"></a></div>
                    </div>  
                     <div class="panel-body" >
                     <form style="background-image:url(back/10.jpg);" id="book" class="form-horizontal" role="form" action="allot_room_backend.php" method="post">
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                  <label for="middle_name" class="col-md-3 control-label" style="color:black">Course.</label>
                    <div class="col-md-9">
                    <input type="text" class="form-control" name="course" placeholder="Course." size="30" id="mna" onblur="mncheck();"><span id="mspn" style="color:red"></span>
                    </div>
                  </div>

                  <div class="form-group">
                  <label for="middle_name" class="col-md-3 control-label" style="color:black">Branch</label>
                    <div class="col-md-9">
                    <input type="text" class="form-control" name="branch" placeholder="Branch." size="30" id="mna" onblur="mncheck();"><span id="mspn" style="color:red"></span>
                    </div>
                  </div>

                  
                  <div class="form-group">
                  <label for="middle_name" class="col-md-3 control-label" style="color:black">Year*</label>
                    <div class="col-md-9">
                    <input type="text" class="form-control" name="year" placeholder="Year" size="30" id="mna" onblur="mncheck();"><span id="mspn" style="color:red"></span>
                    </div>
                  </div>

                  <div class="form-group">
                  <label for="middle_name" class="col-md-3 control-label" style="color:black">Session*</label>
                    <div class="col-md-9">
                    <input type="text" class="form-control" name="sess" placeholder="Session" size="30" id="mna" onblur="mncheck();"><span id="mspn" style="color:red"></span>
                    </div>
                  </div>
