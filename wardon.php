...
$userid = $_SESSION['user_id'];
			...
			$sql = "SELECT * FROM `h_wardon` WHERE user_id = '$id'";
      		...
      		$sql1 = "SELECT * FROM h_caretaker WHERE hostel_name = '$row5[2]'";
					 ...
					 <?php
                        ...
                        echo "<caption style='color:#D7DA0F '></capiton>";
                          echo "<tr style=' border-left: 6px solid red; color:#D7DA0F ' align='center'><th>Designation</th><th>Name</th><th>Mobile No.</th><th>Email</th></tr>";
                            ...
                            echo "<tr style=' border-left: 6px solid red; color:#D7DA0F ' align=''><form action='book.php' method='post'><td>Caretaker</td><td>$row1[3] $row1[4] $row1[5]</td><td>$row1[8]</td><td>$row1[7]</td></form></tr>";
